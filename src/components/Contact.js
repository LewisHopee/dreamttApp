...
function Contact() {
    return (
        <div id="Contact" className="flex items-center bg-gradient-to-br from-purple-500 to-purple-800" >
            <div className="w-6/12 ">
                <form className="flex flex-col w-6/12 p-6 mx-auto">
            ...
            <div className="w-6/12">
            <h1 className="text-2xl text-gray-100 text-bold">Contact Us</h1>
                <p className="text-gray-200 text-lg">Phone number: 0751354213</p>
                <p className="text-gray-200 text-lg">Email: dreamtt@dreamtt.com</p>

                <h1 className="text-2xl text-gray-100 text-bold mt-2">Find Us</h1>
                <p className="text-gray-200 text-lg">41 Dreamt street <br/> DT1 0PA <br/> Dreamtshire</p>
            </div>
        </div>
    )
}
